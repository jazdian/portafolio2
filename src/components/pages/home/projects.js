export function loadProjects() {
    ...
    <h2 class="text-4xl font-bold text-center montserrat-alternates-semibold mb-12">
    Proyectos Destacados <a href="#inicio"><i class="bi bi-chevron-up" style="font-size: 2rem; color: cornflowerblue;"></i></a>
    </h2>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Proyecto 1 -->
      <div class="project-card bg-white project-card-exp soft-glass-ui rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6">
          <h3 class="project-title text-2xl montserrat-alternates-semibold font-bold mb-2">Registro de Ventas</h3>
      ...
      <div class="project-card bg-white project-card-exp soft-glass-ui rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6">
          <h3 class="project-title text-2xl montserrat-alternates-semibold font-bold mb-2">Tienda Online</h3>
      ...
      <div class="project-card bg-white project-card-exp soft-glass-ui rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6">
          <h3 class="project-title text-2xl montserrat-alternates-semibold font-bold mb-2">Sistema para ópticas</h3>
      ...
      <div class="project-card bg-white project-card-exp soft-glass-ui rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6">
          <h3 class="project-title text-2xl montserrat-alternates-semibold font-bold mb-2">Grupo Sur Promociones</h3>
      ...
      <div class="project-card bg-white project-card-exp soft-glass-ui rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6">
          <h3 class="project-title text-2xl montserrat-alternates-semibold font-bold mb-2">Telcel</h3>
          <p class="text-gray-300 ubuntu-sans-mono-code mb-4">
      ...
      <div class="project-card bg-white project-card-exp soft-glass-ui rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6">
          <h3 class="project-title text-2xl montserrat-alternates-semibold font-bold mb-2">Afore XXI Banorte</h3>
          <p class="text-gray-300 ubuntu-sans-mono-code mb-4">
