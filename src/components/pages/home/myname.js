export function loadMyName() {
    const content = /* html */
    `<section id="inicio" class="flex items-center justify-center h-screen z-10">
      <div class="text-center">
          <!-- Internal Links -->
        <div class="space-x-4">
          <a href="#experiencia" class="ubuntu-sans-mono-code text-gray-300 hover:text-white">&lt;experiencia/&gt;</a>
